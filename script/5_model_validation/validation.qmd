...
microbio_pooled_hurricane <- microbio_with_risk_hurricane %>%
  mutate(Ecoli_Result_Binary = ifelse(Ecoli_Result %in% c("0", "<1", "Absent"), "Absent", "Present")) %>%
  mutate(Coliform_Result_Binary = ifelse(Total_Coliform_Result%in% c("0", "<1", "Absent"), "Absent", "Present"))
