...
```
After filtering the dates, there were `{r} n_microbio_pooled_filtered` samples in `microbio_pooled_filtered` (all locations) and `{r} n_microbio_pooled_affected_filtered` samples for `microbio_pooled_affected_filtered` (western counties).
